...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | ----------------------------------------------------------------- |
| `dev`          | `pnpm --filter @obscura/web dev`                                                                                                 | Yes, when app scaffold exists       | Starts the Vite dev server for the web app.                       |
| `build`        | `pnpm --filter @obscura/web build`                                                                                               | Yes, when app scaffold exists       | Produces a production static build.                               |
| `typecheck`    | `pnpm --filter @obscura/web typecheck && pnpm --filter @obscura/shared typecheck && pnpm --filter @obscura/media-core typecheck` | Yes, when packages exist            | TypeScript must pass for app and shared/media packages.           |
| `lint`         | `pnpm --filter @obscura/web lint && pnpm --filter @obscura/shared lint && pnpm --filter @obscura/media-core lint`                | Yes, when packages exist            | ESLint must cover app, workers, and shared packages.              |
...
| `test`         | `pnpm --filter @obscura/web test && pnpm --filter @obscura/shared test && pnpm --filter @obscura/media-core test`                | Yes, when testable code exists      | Runs unit/component tests through Vitest.                         |
| `test:watch`   | `pnpm --filter @obscura/web test:watch`                                                                                          | Later                               | Local development convenience.                                    |
| `test:e2e`     | `pnpm --filter @obscura/web test:e2e`                                                                                            | Yes, after first UI workflow exists | Runs Playwright browser tests with small media fixtures.          |
...
| `clean`        | `pnpm --filter @obscura/web clean && pnpm --filter @obscura/shared clean && pnpm --filter @obscura/media-core clean`             | Later                               | Removes generated build/test artifacts where useful.              |
